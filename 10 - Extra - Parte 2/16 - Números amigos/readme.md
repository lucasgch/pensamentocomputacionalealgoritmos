...
Dois números inteiros positivos a e  b b são amigos se a soma dos divisores de a (com exceção do próprio a) é igual a b e a soma dos divisores de 
b (com exceção do próprio b) é igual a a. Por exemplo, 220 e 284 são amigos, pois:
...
Retorno
int
A soma dos divisores de n (com exceção do próprio n).
...
Retorno
bool
Igual a true, se a e b são amigos, ou false, caso contrário.
